					...
					<PerfectScrollbar className="dz-demo-content">
						<div className="dz-wrapper row">
							<div className="col-xl-3 col-md-6 mb-4">
								<div className="overlay-bx dz-demo-bx ">
									<div className="overlay-wrapper">
										<img loading="lazy" src={demo1} alt="" className="w-100" />
									</div>
							...
							<div className="col-xl-3 col-md-6 mb-4">
								<div className="overlay-bx dz-demo-bx ">
									<div className="overlay-wrapper">
										<img loading="lazy" src={demo2} alt="" className="w-100" />
									</div>
									<div className="overlay-layer">
							...
							<div className="col-xl-3 col-md-6 mb-4">
								<div className="overlay-bx dz-demo-bx ">
									<div className="overlay-wrapper">
										<img loading="lazy" src={demo3} alt="" className="w-100" />
									</div>
									<div className="overlay-layer">
							...
							<div className="col-xl-3 col-md-6 mb-4">
								<div className="overlay-bx dz-demo-bx ">
									<div className="overlay-wrapper">
										<img loading="lazy" src={demo4} alt="" className="w-100" />
									</div>
									<div className="overlay-layer">
							...
							<div className="col-xl-3 col-md-6 mb-4">
								<div className="overlay-bx dz-demo-bx ">
									<div className="overlay-wrapper">
										<img loading="lazy" src={demo5} alt="" className="w-100" />
									</div>
									<div className="overlay-layer">
							...
							<div className="col-xl-3 col-md-6 mb-4">
								<div className="overlay-bx dz-demo-bx ">
									<div className="overlay-wrapper">
										<img loading="lazy" src={demo6} alt="" className="w-100" />
									</div>
									<div className="overlay-layer">
							...
							<div className="col-xl-3 col-md-6 mb-4">
								<div className="overlay-bx dz-demo-bx ">
									<div className="overlay-wrapper">
										<img loading="lazy" src={demo7} alt="" className="w-100" />
									</div>
									<div className="overlay-layer">
							...
							<div className="col-xl-3 col-md-6 mb-4">
								<div className="overlay-bx dz-demo-bx ">
									<div className="overlay-wrapper">
										<img loading="lazy" src={demo8} alt="" className="w-100" />
									</div>
									<div className="overlay-layer">
