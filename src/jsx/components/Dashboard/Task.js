										...
										<div className="add-contact-content">
											<div className="image-placeholder">
												...
												<div className="avatar-preview">
													<div id="imagePreview">
														<img loading="lazy" id="saveImageFile" src={file ? URL.createObjectURL(file) : user}
					...
					<div className="col-xl-3 col-xxl-4 col-lg-6 col-md-6 col-sm-6" key={index}>
						<div className="card project-boxed">
							<div className="img-bx">
								<img loading="lazy" src={contact.image} alt="" className=" me-3 card-list-img w-100" width="130" />
							</div>
