...
import { getAllDepositRequest, updateDepositStatus } from "../../../Redux/coins";

const DataDepositTable = ({ header, description, rows, columns, trade = false }) => {
                                ...
                                <tbody >
                                   { rows.map((item, index) => (
                                        <tr key={index} >
                                            ...
                                            <td className="text-center"><Button  variant="info" style={{backgroundColor:'#3eacff'   ,color: "white"}}  onClick={()=> handleAccept(item.id)} >Accept</Button>
...
export default DataDepositTable;